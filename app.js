...
/* === Autoplay-Button neben Training-Button einordnen === */
...
setTimeout(() => {
    ...
    // Elternknoten des Training-Buttons
    ...
    // Wenn nicht – neue Flex-Gruppe erstellen
    if (!group) {
        group = document.createElement("div");
        group.className = "training-group";

        // Training-Button in die neue Gruppe verschieben
    ...
    console.log("[UI] Autoplay-Button neben Training-Button platziert.");
}, 120);
``
    /* ============================ BUTTON EVENTS =========================== */
